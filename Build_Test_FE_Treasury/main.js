...
class JwtInterceptor {
  ...
  intercept(req, next) {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.catchError)(err => this.handleError(err, authedReq, next)));
  }
  saveUserFromGetAccess(res) {
    ...
    this.tokenStore.saveUser({
      ...
      profileImage: enhanced?.userDetails?.profileImage ?? ''
    });
...
/* harmony export */ });
/* harmony import */ var E_Repos_DX_FE_DX_FE_Treasury_DX_FE_Treasury_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
class ExcelService {
  ...
  exportToExcelFunc(workbook, exportToExcelOptions) {
    return (0,E_Repos_DX_FE_DX_FE_Treasury_DX_FE_Treasury_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
class HelperService {
  constructor(_datePipe, _router) {
    ...
    this.fileToBase64 = /*#__PURE__*/function () {
      var _ref = (0,E_Repos_DX_FE_DX_FE_Treasury_DX_FE_Treasury_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (file) {
